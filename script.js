...
let header = [
    {
        ...
        'object': menuItems.vorspeisen
    },
    {
        'name': 'Salat',
        'image': './assets/icons/salad.png',
        'object': menuItems.salate
    },
    {
        'name': 'Hauptgericht',
        'image': './assets/icons/main_course.png',
        'object': menuItems.hauptgerichte
    }
]
...
function saveToLocalStorage() {
    localStorage.setItem('basketOrderName', JSON.stringify(basketOrder.name));
...
function getFromLocalStorage() {
    let arrName = JSON.parse(localStorage.getItem('basketOrderName'));
...
function calcBasket() {
    basketSum = 0;
    for (let Sum = 0; Sum < basketOrder.preis.length; Sum++) {
        basketSum += basketOrder.preis[Sum];
    }
